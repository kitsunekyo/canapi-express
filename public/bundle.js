...
/******/ 	return __webpack_require__(__webpack_require__.s = "./admin/assets/js/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./admin/assets/js/components/App/App.jsx":
/*!************************************************!*\
  !*** ./admin/assets/js/components/App/App.jsx ***!
  \************************************************/
...
/***/ "./admin/assets/js/components/Dashboard/Dashboard.jsx":
/*!************************************************************!*\
  !*** ./admin/assets/js/components/Dashboard/Dashboard.jsx ***!
  \************************************************************/
/*! no static exports found */
...
var _Monitor = __webpack_require__(/*! ./../Monitor/Monitor.jsx */ "./admin/assets/js/components/Monitor/Monitor.jsx");

var _Monitor2 = _interopRequireDefault(_Monitor);

var _EventLog = __webpack_require__(/*! ./../EventLog/EventLog.jsx */ "./admin/assets/js/components/EventLog/EventLog.jsx");

var _EventLog2 = _interopRequireDefault(_EventLog);

var _Pump = __webpack_require__(/*! ./../Pump/Pump.jsx */ "./admin/assets/js/components/Pump/Pump.jsx");
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            { className: "column" },
            React.createElement(_Monitor2.default, null)
          ),
          React.createElement(
            "div",
            { className: "column" },
            React.createElement(_EventLog2.default, null)
          )
        ),
        React.createElement(
          "div",
          ...
          React.createElement(
            ...
            React.createElement(_Pump2.default, null)
          )
        )
      );
    }
...
/***/ "./admin/assets/js/components/EventLog/EventLog.jsx":
/*!**********************************************************!*\
  !*** ./admin/assets/js/components/EventLog/EventLog.jsx ***!
  \**********************************************************/
/*! no static exports found */
...
var EventLog = function (_React$Component) {
  ...
  function EventLog(props) {
    ...
    var _this = _possibleConstructorReturn(this, (EventLog.__proto__ || Object.getPrototypeOf(EventLog)).call(this, props));
  ...
  _createClass(EventLog, [{
    ...
    value: function fetchEvents() {
      ...
      _axios2.default.get("http://localhost:8080/api/event").then(function (res) {
        _this2.setState({
          events: res.data
        });
      });
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "a",
            { href: "#", className: "card-header-icon", "aria-label": "more options" },
            React.createElement(
              "span",
              { className: "icon" },
...
/***/ "./admin/assets/js/components/Header/Header.jsx":
/*!******************************************************!*\
  !*** ./admin/assets/js/components/Header/Header.jsx ***!
  \******************************************************/
/*! no static exports found */
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("img", { src: "/img/logo-landscape.png", alt: "logo" })
            ),
            React.createElement(
              "a",
              {
...
/***/ "./admin/assets/js/components/Monitor/Monitor.jsx":
/*!********************************************************!*\
  !*** ./admin/assets/js/components/Monitor/Monitor.jsx ***!
  \********************************************************/
/*! no static exports found */
...
var Monitor = function (_React$Component) {
  ...
  _createClass(Monitor, [{
    ...
    key: 'fetchMonitor',
    value: function fetchMonitor() {
      var _this2 = this;

      _axios2.default.get('http://localhost:8080/api/status').then(function (res) {
        _this2.setState({
          status: res.data,
          loading: false
        });
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'a',
            { href: '#', className: 'card-header-icon', 'aria-label': 'more options', onClick: this.handleReloadClick.bind(this) },
            React.createElement(
              'span',
              { className: 'icon' },
              React.createElement('i', { className: 'fas fa-sync-alt ' + (this.state.loading ? 'fa-spin' : ''), 'aria-hidden': 'true' })
            )
          )
        ),
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { className: 'monitor-segment' },
              React.createElement(
                'div',
                { className: 'monitor-segment__value' },
                this.state.status.air_humidity,
                ' ',
                React.createElement(
                  'span',
                  null,
              ...
              React.createElement(
                'div',
                { className: 'monitor-segment__label' },
                'Air Humidity'
              )
            ),
            React.createElement(
              ...
              React.createElement(
                'div',
                { className: 'monitor-segment__value' },
                this.state.status.air_temperature,
                ' ',
                React.createElement(
                  'span',
                  null,
...
/***/ "./admin/assets/js/components/Pump/Pump.jsx":
/*!**************************************************!*\
  !*** ./admin/assets/js/components/Pump/Pump.jsx ***!
  \**************************************************/
/*! no static exports found */
...
var Pump = function (_React$Component) {
  _inherits(Pump, _React$Component);

  function Pump(props) {
    _classCallCheck(this, Pump);

    var _this = _possibleConstructorReturn(this, (Pump.__proto__ || Object.getPrototypeOf(Pump)).call(this, props));
  ...
  _createClass(Pump, [{
    key: "handleWaterClick",
    value: function handleWaterClick(e) {
      e.preventDefault();
    ...
    value: function sendWater() {
      ...
      _axios2.default.post("http://localhost:8080/api/pump/water").then(function (res) {
        _this2.runProgress().then(function () {
          _this2.setState({
            watering: false
          });
        });
    ...
    value: function runProgress() {
      ...
      return new Promise(function (resolve, reject) {
        var __progress = _this3.state.progress;
        var interval = setInterval(function () {
          if (_this3.state.progress >= 100) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            this.state.watering ? React.createElement(
              "div",
              null,
              React.createElement(
                "span",
...
__webpack_require__(/*! ./../scss/index.scss */ "./admin/assets/scss/index.scss");

var _App = __webpack_require__(/*! ./components/App/App.jsx */ "./admin/assets/js/components/App/App.jsx");
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/sass-loader/lib/loader.js!./index.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./admin/assets/scss/index.scss");
...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./admin/assets/scss/index.scss":
/*!*********************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./admin/assets/scss/index.scss ***!
  \*********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
